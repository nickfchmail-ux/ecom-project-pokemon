...
function Card({ product }) {
  return (
    <div className="relative flex w-full flex-col place-items-center overflow-hidden rounded-xl bg-white shadow-lg transition-shadow hover:bg-amber-100 hover:shadow-2xl">
      <Image url={product.image} id={product.id} />
      <div className="flex w-full flex-col items-start p-3">
        <ProductName name={product.name} />

        <div className="mt-4 flex w-full items-center justify-between">
          <Price price={product.regular_price} font={"card"} />
